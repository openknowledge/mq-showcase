...
public class ProducerConsumerIT extends AbstractIntegrationTest {
  ...
  void sendAndReceiveMessage() throws TimeoutException {
    ...
    waitingConsumer.waitUntil(frame -> frame.getUtf8String().contains("Message processed successfully"), 30, TimeUnit.SECONDS);

    String consumerLogs = QUEUE_CONSUMER_A.getLogs();
