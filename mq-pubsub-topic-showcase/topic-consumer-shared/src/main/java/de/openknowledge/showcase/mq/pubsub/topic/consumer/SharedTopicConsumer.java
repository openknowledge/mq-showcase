...
/**
 * Shared durable JMS consumer that receives messages from a topic. The topic is configured in the server.xml.
 */
...
public class SharedTopicConsumer implements MessageListener {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(SharedTopicConsumer.class);
